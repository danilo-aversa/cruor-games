# Phase 8 batch 14 — Jikininki Candidate 1 editorial review

## Decision requested

Review `jikininki-semantic-v2` as a canonical Inspiration v2 candidate. Candidate 1 owns **Inspiration Archive + Dark Places only**, contains zero Monster Composer components, and never copies modern Monster data.

| Tracking field | Value |
| --- | --- |
| Module | `jikininki` |
| Candidate | `phase8-jikininki-editorial-candidate-v1` |
...
25 modern Monster grafts remain external and are parity-checked by source anchor.
...
2. `japanese-folklore-review-required`;
3. `sample-qa-local-verification-required`;
4. `image-provenance-required`.

## Approval wording

> Approvo Jikininki Candidate 1 per la Fase 8. Reviewer: Danilo.
