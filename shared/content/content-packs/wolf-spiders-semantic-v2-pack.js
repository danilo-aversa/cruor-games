...
const REVIEW_VERSION = "phase8-wolf-spiders-editorial-approved-v2";
...
function createProvenance({
  ...
  migrationNote = "AI-assisted editorial migration approved by Danilo on 2026-07-17 after biological-source review and repeatable local sample QA. Existing Monster Composer grafts remain externally owned and are verified only by source-anchor parity. Image provenance remains an independent publication gate.",
} = {}) {
  ...
  modules: [
    {
      ...
      sourceAnchor: {
        ...
        editorialNotes: [
          ...
          "Fictional transformation: giant warrens, Tremor Pressure, supernatural carrier swarms, corrosive silk, and engineered alarm networks are original Cruor game content. Monster rules are not owned or embedded by this semantic module.",
          ...
          "Ownership boundary: the 32 existing Wolf Spiders Monster grafts remain solely in features/monster-composer/data/monster-grafts.js and are linked externally by source-anchor parity.",
          "Publication gate: biological-source review and repeatable local sample QA were approved by Danilo on 2026-07-17. Verifiable image provenance is still required.",
        ],
