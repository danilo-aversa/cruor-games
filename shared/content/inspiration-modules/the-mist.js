...
export const THE_MIST_MONSTER_GRAFT_COMPONENTS = THE_MIST_MODULE_EXPORTS.monsterGrafts;
export const THE_MIST_LOCATION_COMPONENTS = THE_MIST_MODULE_EXPORTS.locationComponents;
export const THE_MIST_LOCATION_REGION_COMPONENTS = THE_MIST_MODULE_EXPORTS.locationRegions;
export const THE_MIST_REFERENCED_SOURCE_ANCHORS = THE_MIST_MODULE_EXPORTS.referencedSourceAnchors;
