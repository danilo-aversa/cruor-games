...
export const SEDLEC_OSSUARY_INSPIRATION_MODULE = buildCoreInspirationModuleFromCard(
...
const SEDLEC_OSSUARY_MODULE_EXPORTS = buildModuleExports(SEDLEC_OSSUARY_INSPIRATION_MODULE);

export const SEDLEC_OSSUARY_SOURCE_ANCHOR = SEDLEC_OSSUARY_MODULE_EXPORTS.sourceAnchor;
export const SEDLEC_OSSUARY_INSPIRATION = SEDLEC_OSSUARY_MODULE_EXPORTS.inspiration;
export const SEDLEC_OSSUARY_MONSTER_GRAFT_COMPONENTS = SEDLEC_OSSUARY_MODULE_EXPORTS.monsterGrafts;
export const SEDLEC_OSSUARY_LOCATION_COMPONENTS = SEDLEC_OSSUARY_MODULE_EXPORTS.locationComponents;
export const SEDLEC_OSSUARY_LOCATION_REGION_COMPONENTS = SEDLEC_OSSUARY_MODULE_EXPORTS.locationRegions;
export const SEDLEC_OSSUARY_REFERENCED_SOURCE_ANCHORS = SEDLEC_OSSUARY_MODULE_EXPORTS.referencedSourceAnchors;
