...
export function MonsterComposerTopbar({
  ...
  return (
    <div className="monster-workspace__topbar monster-topbar-wrap">
      <header className="monster-topbar">
        <div className="monster-topbar__primary">
          <h1 className="monster-topbar__title">
            <span className="monster-topbar__title-prefix">I need to</span>
            <span className="monster-topbar__need-value">Build a Monster</span>
          </h1>
          <div className="monster-topbar__control-row">
            <div
              className="mode-switch monster-topbar__mode-switch"
              aria-label="Choose what you need to do"
            >
              <button
                className="mode-btn"
                type="button"
                aria-label="Location Composer"
                aria-pressed="false"
              >
                <BookOpen aria-hidden="true" />
                <span className="sr-only">Location Composer</span>
              </button>
              <button
            ...
            <div className="monster-topbar__right">
              ...
              <div
                className="monster-workspace__tabs"
                role="tablist"
                aria-label="Monster composer views"
              >
                <button
                  className={`monster-workspace__tab ${viewMode === "composer" ? "is-active" : ""}`}
                  type="button"
                  role="tab"
                ...
                {uiMode === "debug" && (
                  <button
                    className={`monster-workspace__tab ${viewMode === "balance" ? "is-active" : ""}`}
                    type="button"
                    role="tab"
                ...
                {uiMode === "debug" && (
                  <button
                    className={`monster-workspace__tab ${viewMode === "run" ? "is-active" : ""}`}
                    type="button"
                    role="tab"
                ...
                <button
                  className={`monster-workspace__tab ${viewMode === "export" ? "is-active" : ""}`}
                  type="button"
                  role="tab"
              ...
              {uiMode === "debug" && (
                <div className="monster-debug-tools" aria-label="Monster debug tools">
                  <button
                    className={`monster-workspace__tab monster-debug-popout-tab ${liveExportPopoutOpen ? "is-active" : ""}`}
                    type="button"
